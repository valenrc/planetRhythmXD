...
func _ready() -> void:
	...
	$CenterContainer2/Text.text = (
		"Press " + GlobalScripts.Hit_tecla.to_upper()
		+ " or " + GlobalScripts.Hit_tecla2.to_upper()
		+ " to the beat"
	)
...
func _unhandled_input(event: InputEvent) -> void:
	# Solo permitir salir una vez terminada la calibración.
	...
	# Saltar automáticamente notas ya perdidas para no trabar la calibración.
	...
	# Ignorar inputs fuera de la ventana de aceptación
...
func _on_conductor_finished() -> void:
	...
	if not offsets.is_empty():
		...
		$CenterContainer2/Text.text = (
			"Offset: " + str(snapped(GlobalScripts.global_offset, 0.1)) + " ms saved"
